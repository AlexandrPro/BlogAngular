...
var ArticleComponent = (function () {
    ...
    ArticleComponent.prototype.LoadArticles = function () {
        ...
        this._articleService.get(global_1.Global.BASE_USER_ENDPOINT)
    ...
    ArticleComponent.prototype.onSubmit = function (formData) {
        ...
        switch (this.dbops) {
            case enum_1.DBOperation.create:
                this._articleService.post(global_1.Global.BASE_USER_ENDPOINT, formData._value).subscribe(function (data) {
                    if (data == 1) {
            ...
            case enum_1.DBOperation.update:
                this._articleService.put(global_1.Global.BASE_USER_ENDPOINT, formData._value.Id, formData._value).subscribe(function (data) {
                    if (data == 1) {
            ...
            case enum_1.DBOperation.delete:
                this._articleService.delete(global_1.Global.BASE_USER_ENDPOINT, formData._value.Id).subscribe(function (data) {
                    if (data == 1) {
...
], ArticleComponent.prototype, "modal", void 0);
